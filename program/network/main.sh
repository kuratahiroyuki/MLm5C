...
python ml_train_test_m5C.py  --intrain ${train_path} --intest ${test_file} --outpath ${result_path} --machine ${machine_method}  --encode ${encode_method} --fold ${kfold} --seqwin ${seqwin}
