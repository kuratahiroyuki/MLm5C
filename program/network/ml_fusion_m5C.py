...
if __name__ == '__main__':
    ...
    encode_method=['RCKmer', 'DNC', 'TNC', 'ENAC', 'binary', 'CKSNAP', 'NCP', 'ANF', 'EIIP']   
      
    combination = []
    combination.append(['LGBM','EIIP'])
    combination.append(['LGBM','binary'])
    combination.append(['LGBM','NCP']) 
    combination.append(['LGBM','ENAC'])
     
    #combination.append(['SVM','binary'])
    #combination.append(['SVM','NCP']) 
    #combination.append(['SVM','ENAC'])  
